...
public class GoalsService : IGoalsService
{
    ...
    {
        //var filter = Builders<Goal>.Filter.Eq("Id", updatedGoal.Id);

        await _goalsCollection.ReplaceOneAsync(x => x.Id == id, updatedGoal, new ReplaceOptions { IsUpsert = true });
    }


    //(x => x.Id == id, updatedGoal);
